        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card ">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{url('product/save-brand')}}" class="form-horizontal" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                            ...
                            <table id="example" class="display" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="background: #d1d1d1;">@if(!empty($row->logo))<img src="{{asset($row->logo)}}" style="width:50px;height:30px;object-fit:cover">@endif</td>
                                        <td>{{$row->whatsapp}}</td>
                                        <td><a href="{{url('product/update-brand',$row->id)}}">Edit</a> / <a onclick="return confirm('Are you sure you want to delete this ?');" href="{{url('product/delete-brand',$row->id)}}">Delete</a></td>
                                    </tr>
                                    @endforeach
                                    @endif
                                </tbody>
