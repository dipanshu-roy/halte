        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card ">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{url('admin/product/save-product-category')}}" class="form-horizontal" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-group bmd-form-group textarea">
                                        ...
                                        <input name="category_name" maxlength="100" class="form-control" type="text" value="@if(!empty($update->category_name)){{$update->category_name}}@else{{old('category_name')}}@endif" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-group bmd-form-group textarea">
                                        ...
                                        @if(!empty($update->logo))
                                            <img src="{{asset($update->logo)}}" style="width:80px;height:30px;object-fit:cover">
                                        @endif
                                    </div>
                                </div>
                            </div>
                            ...
                            <table id="example" class="display" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{url('admin/product/update-product-category',$row->id)}}">Edit</a> / <a onclick="return confirm('Are you sure you want to delete this ?');" href="{{url('admin/product/delete-product-category',$row->id)}}">Delete</a></td>
                                    </tr>
                                    @endforeach
                                    @endif
                                </tbody>
