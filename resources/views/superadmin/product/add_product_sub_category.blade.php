        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card ">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{url('admin/product/save-product-sub-category')}}" class="form-horizontal" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                            ...
                            <table id="example" class="display" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{url('admin/product/update-product-sub-category',$row->id)}}">Edit</a> / <a onclick="return confirm('Are you sure you want to delete this ?');" href="{{url('admin/product/delete-product-sub-category',$row->id)}}">Delete</a></td>
                                    </tr>
                                    @endforeach
                                    @endif
                                </tbody>
