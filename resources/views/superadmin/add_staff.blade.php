        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card ">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{url('admin/add-staff')}}" class="form-horizontal" autocomplete="off">
                            @csrf
                            <div class="row">
                            ...
                            <table id="example" class="display" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$row->mobile}}</td>
                                        <td>{{$row->type}}</td>
                                        <td><a href="{{url('admin/update-staff',$row->id)}}">Edit</a> @if($row->id!=1)/ <a onclick="return confirm('Are you sure you want to delete this ?');" href="{{url('admin/delete-staff',$row->id)}}">Delete</a>@endif</td>
                                    </tr>
                                    @endforeach
                                    @endif
                                </tbody>
