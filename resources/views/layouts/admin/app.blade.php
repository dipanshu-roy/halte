                ...
                <ul class="nav">
                    ...
                    <li class="nav-item ">
                        ...
                        <div class="collapse" id="programs">
                            <ul class="nav">
                                <li class="nav-item ">
                                    <a class="nav-link" href="{{url('product/add-brand')}}">
                                        <span class="sidebar-mini"> </span>
                                        <span class="sidebar-normal">Add Brand</span>
                                    </a>
                                </li>
                                <li class="nav-item ">
                                    <a class="nav-link" href="{{url('product/add-product-category')}}">
                                        <span class="sidebar-mini"> </span>
                                        <span class="sidebar-normal">Add Main Category</span>
                                    </a>
                                </li>
                                <li class="nav-item ">
                                    <a class="nav-link" href="{{url('product/add-product-sub-category')}}">
                                        <span class="sidebar-mini"> </span>
                                ...
                                <li class="nav-item ">
                                    <a class="nav-link" href="{{url('product/add-product')}}">
                                        <span class="sidebar-mini"> </span>
                    ...
                    <li class="nav-item ">
                        ...
                        <div class="collapse" id="pages">
                            <ul class="nav">
                                ...
                                <li class="nav-item ">
                                    <a class="nav-link" href="{{ url('become-dealer') }}">
                                        <span class="sidebar-mini"> </span>
                                ...
                                <li class="nav-item ">
                                    <a class="nav-link" href="{{ url('terms-and-condition') }}">
                                        <span class="sidebar-mini"> </span>
                                        <span class="sidebar-normal">Terms &amp; Conditions</span>
                                    </a>
                                </li>
                                <li class="nav-item ">
                                    <a class="nav-link" href="{{ url('spares-and-services') }}">
                                        <span class="sidebar-mini"> </span>
                                ...
                                <li class="nav-item ">
                                    <a class="nav-link" href="{{ url('demo-and-installation') }}">
                                        <span class="sidebar-mini"> </span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" {{(request()->is('add-staff'))?'active':''}}
                            href="{{url('add-staff')}}">
                            <i class="material-icons"></i>
                            <p>Add Staff</p>
                        </a>
